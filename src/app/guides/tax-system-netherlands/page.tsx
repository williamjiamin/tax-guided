...
import { NL_TAX_SYSTEM } from "@/lib/tax-data";

export const metadata: Metadata = {
  title: "Netherlands Tax System Guide — Corporate, Individual & VAT Rates",
  description:
    "Complete guide to the Netherlands tax system: 19%/25.8% corporate rate, box system, participation exemption, innovation box, 30% ruling, and 21% VAT.",
  alternates: { canonical: "/guides/tax-system-netherlands" },
};

export default function TaxSystemNetherlandsPage() {
  const tax = NL_TAX_SYSTEM;
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
        ...
        <section className="bg-gradient-to-b from-navy-dark to-navy pt-16 pb-12 px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              Everything you need to know about taxation in the {tax.country} — corporate rates, the box
              system, participation exemption, 30% ruling, and key holding company advantages.
            </p>
          </div>
        </section>
        ...
        <section className="py-12 px-6 bg-gray-50">
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
              ...
              <p className="text-3xl font-extrabold text-navy mt-2">49.5%</p>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 px-6 bg-gray-50">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-extrabold text-gray-900 mb-6">Individual Income Tax Brackets (Box 1)</h2>
            ...
            <p className="text-sm text-gray-500 mt-3">
              Box 1 rates include social security contributions. Box 2 (substantial interest) and Box 3
              (savings/investments) have separate rate structures.
            </p>
          </div>
        </section>
        ...
        <section className="py-12 px-6 bg-gray-50">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-extrabold text-gray-900 mb-4">Value Added Tax (VAT / BTW)</h2>
        ...
        <section className="py-12 px-6">
          <div className="max-w-4xl mx-auto flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              Compare the {tax.country} with Other Jurisdictions &rarr;
            </Link>
            <a
