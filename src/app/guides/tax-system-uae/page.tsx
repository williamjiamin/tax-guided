...
import { AE_TAX_SYSTEM } from "@/lib/tax-data";

export const metadata: Metadata = {
  title: "UAE Tax System Guide — Corporate, Individual & VAT Rates",
  description:
    "Complete guide to the UAE tax system: 9% corporate tax, 0% personal income tax, 5% VAT, free zone benefits, and no withholding taxes.",
  alternates: { canonical: "/guides/tax-system-uae" },
};

export default function TaxSystemUAEPage() {
  const tax = AE_TAX_SYSTEM;
      ...
      <main className="flex-1">
        ...
        <section className="bg-gradient-to-b from-navy-dark to-navy pt-16 pb-12 px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              Everything you need to know about taxation in the {tax.country} — corporate rates,
              personal income tax, VAT, withholding, and free zone incentives.
            </p>
          </div>
        </section>
        ...
        <section className="py-12 px-6 bg-gray-50">
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
              <p className="text-sm font-semibold text-gray-500 uppercase tracking-wide">Personal Income Tax</p>
              <p className="text-3xl font-extrabold text-navy mt-2">0%</p>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 px-6 bg-gray-50">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-extrabold text-gray-900 mb-4">Individual Income Tax</h2>
            <div className="bg-white rounded-xl p-6 border border-gray-100">
              <p className="text-lg font-bold text-navy mb-3">No personal income tax</p>
              <p className="text-gray-700 leading-relaxed">
                The UAE does not impose personal income tax on individuals. Employment income, investment
                income, and other personal earnings are not taxed at the individual level. This applies
        ...
        <section className="py-12 px-6 bg-gray-50">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-extrabold text-gray-900 mb-6">
              Why Businesses Choose the {tax.country}
            </h2>
        ...
        <section className="py-12 px-6">
          <div className="max-w-4xl mx-auto flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              Compare the UAE with Other Jurisdictions &rarr;
            </Link>
            <a
