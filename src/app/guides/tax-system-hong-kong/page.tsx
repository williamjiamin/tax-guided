...
import { HK_TAX_SYSTEM } from "@/lib/tax-data";

export const metadata: Metadata = {
  title: "Hong Kong Tax System Guide — Profits Tax, Salaries Tax & Withholding",
  description:
    "Complete guide to Hong Kong's tax system: 8.25%/16.5% two-tiered profits tax, no VAT, no capital gains tax, territorial taxation, and low withholding rates.",
  alternates: { canonical: "/guides/tax-system-hong-kong" },
};

export default function TaxSystemHongKongPage() {
  const tax = HK_TAX_SYSTEM;
      ...
      <main className="flex-1">
        ...
        <section className="bg-gradient-to-b from-navy-dark to-navy pt-16 pb-12 px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              Everything you need to know about taxation in {tax.country} — profits tax, salaries tax,
              territorial source principle, and why it remains a global business hub.
            </p>
          </div>
        </section>
        ...
        <section className="py-12 px-6 bg-gray-50">
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
              <p className="text-sm font-semibold text-gray-500 uppercase tracking-wide">Profits Tax Rate</p>
              <p className="text-3xl font-extrabold text-navy mt-2">{tax.corporateRate}</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
              <p className="text-sm font-semibold text-gray-500 uppercase tracking-wide">VAT / Sales Tax</p>
        ...
        <section className="py-12 px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-extrabold text-gray-900 mb-4">Profits Tax (Corporate Tax)</h2>
        ...
        <section className="py-12 px-6 bg-gray-50">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-extrabold text-gray-900 mb-6">Salaries Tax Brackets</h2>
            ...
            <p className="text-sm text-gray-500 mt-3">
              Salaries tax is capped at a standard rate of 15% on net income without personal deductions.
            </p>
          </div>
        </section>
        ...
        <section className="py-12 px-6 bg-gray-50">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-extrabold text-gray-900 mb-4">VAT / Sales Tax</h2>
