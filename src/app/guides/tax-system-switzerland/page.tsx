...
import { CH_TAX_SYSTEM } from "@/lib/tax-data";

export const metadata: Metadata = {
  title: "Switzerland Tax System Guide — Federal, Cantonal & Municipal Rates",
  description:
    "Complete guide to Switzerland's tax system: 12-14% effective corporate rate, three-level taxation, no private capital gains tax, 8.1% VAT, and cantonal competition.",
  alternates: { canonical: "/guides/tax-system-switzerland" },
};

export default function TaxSystemSwitzerlandPage() {
  const tax = CH_TAX_SYSTEM;
      ...
      <main className="flex-1">
        ...
        <section className="bg-gradient-to-b from-navy-dark to-navy pt-16 pb-12 px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              Everything you need to know about taxation in {tax.country} — three-level taxation, cantonal
              competition, individual brackets, VAT, and wealth tax considerations.
            </p>
          </div>
        </section>
        ...
        <section className="py-12 px-6 bg-gray-50">
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
              <p className="text-sm font-semibold text-gray-500 uppercase tracking-wide">Capital Gains (Private)</p>
        ...
        <section className="py-12 px-6 bg-gray-50">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-extrabold text-gray-900 mb-6">Federal Individual Income Tax Brackets</h2>
            <p className="text-sm text-gray-500 mb-4">
              These are federal rates only. Cantonal and communal taxes are levied on top, varying
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b-2 border-navy">
                    ...
                    <th className="py-3 px-4 text-sm font-semibold text-gray-600">Federal Rate</th>
                  </tr>
                </thead>
                <tbody>
