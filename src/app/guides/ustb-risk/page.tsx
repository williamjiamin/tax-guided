...
export const metadata: Metadata = {
  title:
    "US Trade or Business (USTB) Risk for Foreign LLC Owners — When Form 5472 Alone Is Not Enough | ForeignLLCTax.com",
  description:
  ...
  openGraph: {
    ...
    url: "https://foreignllctax.com/guides/ustb-risk",
    type: "website",
  },
