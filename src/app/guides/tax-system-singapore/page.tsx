...
import { SG_TAX_SYSTEM } from "@/lib/tax-data";

export const metadata: Metadata = {
  title: "Singapore Tax System Guide — Corporate, Individual & GST Rates",
  description:
    "Complete guide to Singapore's tax system: 17% corporate rate, progressive individual brackets, 9% GST, territorial taxation, and startup exemptions.",
  alternates: { canonical: "/guides/tax-system-singapore" },
};

export default function TaxSystemSingaporePage() {
  const tax = SG_TAX_SYSTEM;
      ...
      <main className="flex-1">
        ...
        <section className="bg-gradient-to-b from-navy-dark to-navy pt-16 pb-12 px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              ...
              brackets, GST, withholding, and key incentives.
            </p>
          </div>
        </section>
        ...
        <section className="py-12 px-6 bg-gray-50">
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
              <p className="text-sm font-semibold text-gray-500 uppercase tracking-wide">GST / VAT Rate</p>
        ...
        <section className="py-12 px-6 bg-gray-50">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-extrabold text-gray-900 mb-4">Goods &amp; Services Tax (GST)</h2>
