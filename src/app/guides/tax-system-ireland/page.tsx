...
import { IE_TAX_SYSTEM } from "@/lib/tax-data";

export const metadata: Metadata = {
  title: "Ireland Tax System Guide — Corporate, Individual & VAT Rates",
  description:
    "Complete guide to Ireland's tax system: 12.5% corporate rate, Knowledge Development Box, progressive individual brackets, 23% VAT, and R&D credits.",
  alternates: { canonical: "/guides/tax-system-ireland" },
};

export default function TaxSystemIrelandPage() {
  const tax = IE_TAX_SYSTEM;
        ...
        <section className="bg-gradient-to-b from-navy-dark to-navy pt-16 pb-12 px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              ...
              brackets, VAT, withholding, and key incentives for multinationals.
            </p>
          </div>
        </section>
