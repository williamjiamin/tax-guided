...
export const metadata: Metadata = {
  title:
    "Federal Supporting Statements for Form 5472 — What They Are and When You Need Them | TaxGuided.com",
  description:
  ...
  openGraph: {
    ...
    url: "https://taxguided.com/guides/federal-supporting-statements",
    type: "website",
  },
  alternates: {
